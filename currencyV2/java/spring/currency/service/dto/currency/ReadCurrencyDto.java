...
import spring.currency.controller.json.LocalDateTimeDeserializer;
import spring.currency.controller.json.LocalDateTimeSerializer;
...
public class ReadCurrencyDto {
    ...
    //@JsonFormat(shape = JsonFormat.Shape.NUMBER_INT) не работает
